...
INFOGRAPHIC_STYLE_AUTO_SELECT = 1
INFOGRAPHIC_STYLE_SKETCH_NOTE = 2
INFOGRAPHIC_STYLE_PROFESSIONAL = 3
INFOGRAPHIC_STYLE_BENTO_GRID = 4
INFOGRAPHIC_STYLE_EDITORIAL = 5
INFOGRAPHIC_STYLE_INSTRUCTIONAL = 6
INFOGRAPHIC_STYLE_BRICKS = 7
INFOGRAPHIC_STYLE_CLAY = 8
INFOGRAPHIC_STYLE_ANIME = 9
INFOGRAPHIC_STYLE_KAWAII = 10
INFOGRAPHIC_STYLE_SCIENTIFIC = 11

INFOGRAPHIC_STYLES = CodeMapper({
